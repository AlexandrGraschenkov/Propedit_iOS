...
public:
  ...
  void log(strformat::bstr const &message) {
...
#define log_current_location() mtx::log::target_c::get_default_logger() << (strformat::bstr("Current file, line, function: %1%:%2% in %3%") % __FILE__ % __LINE__ % __PRETTY_FUNCTION__)
