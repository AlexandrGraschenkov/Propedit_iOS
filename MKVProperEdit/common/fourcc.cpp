...
val(uint32_t value,
  ...
  return fourcc_c::big_endian == byte_order ? value : mtx::bytes::swap_32(value);
}
...
fourcc_c::description()
  const {
  static auto s_id_fmt   = strformat::bstr("0x%|1$08x| \"%2%%3%%4%%5%\"");
  static auto s_name_fmt = strformat::bstr(": %1%");
